from src.cars.alfa_romeo_gtr import ALFA_ROMEO_GTR_DATA
from src.cars.audi_r8_lms_2016 import AUDI_R8_LMS_2016_DATA
from src.cars.invisible_car import INVISIBLE_CAR
